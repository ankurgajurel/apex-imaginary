      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
        ...
        <div className="mt-5 max-w-3xl text-center mx-auto">
          <p className="text-lg text-gray-600 dark:text-gray-400">
            At Apex Outsourcing, we specialize in providing comprehensive IT
            outsourcing solutions for all your development needs. Our team
            offers a diverse set of services, including web development.
          </p>
        </div>
